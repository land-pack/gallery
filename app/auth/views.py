...
def change_email(token):
    if current_user.change_email(token):
        flash('Your have email address has been updated.')
    else:
...
#         if user is not None:
#             token = user.generate_confirmation_token()  #TODO should add a new method to User Model?
#             send_mail(email,'Reset Your Account',
#                       'auth/email/reset',
#                       user=user, token=token)
#             flash('A resetpassword url has been sent to you by email.')
#
#     return
